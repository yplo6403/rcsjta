...
public class CpmSessionDocument {

    public static final String SESSION_TYPE = "session-type";
    public static final String INVITED_PARTICIPANTS = "invited-participants";

    private final String mSessionType;
    private final List<ContactId> mParticipants;

    public CpmSessionDocument(String sessionType, List<ContactId> participants) {
