...
/**
 * Server side implementation of {@link com.gsma.services.rcs.RcsServiceNotRegisteredException},
 * <p>
 * This exception will be thrown across AIDL layers and will come as a
 * {@link com.gsma.services.rcs.RcsServiceNotAvailableException} on the client side.
 * </p>
 * <p>
 ...
 * </p>
 */
public class ServerApiServiceNotAvailableException extends ServerApiBaseException {
     ...
     */
    public ServerApiServiceNotAvailableException(String message) {
        super(RcsServiceNotAvailableException.class, message);
    }
