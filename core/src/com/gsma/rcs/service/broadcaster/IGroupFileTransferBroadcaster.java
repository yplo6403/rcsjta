...
public interface IGroupFileTransferBroadcaster {
    ...
    void broadcastStateChanged(String chatId, String transferId, State status,
            ReasonCode reasonCode);

    void broadcastProgressUpdate(String chatId, String transferId, long currentSize,
            long totalSize);
    ...
    void broadcastResumeFileTransfer(String filetransferId);

    void broadcastFileTransfersDeleted(String chatId, Set<String> transferIds);

    void broadcastFileTransferRead(String chatId, String transferId);
}
