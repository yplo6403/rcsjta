...
public class SntpClient {
    private static final Logger sLogger = Logger.getLogger(SntpClient.class.getSimpleName());
    ...
    public boolean requestTime(String host, int timeout) {
        ...
        try {
            ...
            long requestTime = NtpTrustedTime.currentTimeMillis();
            ...
            if (sLogger.isActivated()) {
                sLogger.warn("Failed to request the NTP server : " + host, e);
            }
            return false;
        } finally {
            if (socket != null) {
