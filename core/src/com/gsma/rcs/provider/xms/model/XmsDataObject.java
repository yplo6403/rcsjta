...
public abstract class XmsDataObject {
    ...
    /**
     * The thread ID generated by the native SMS application or null if synchronized from CMS
     */
    private final Long mNativeThreadId;

    private final String mChatId;

    public XmsDataObject(String messageId, ContactId contact, String mimeType, Direction dir,
            long timestamp, Long nativeId, Long threadId) {
