...
public enum CmsOperation {
     ...
     * @return instance
     */
    public static CmsOperation valueOf(int value) {
        CmsOperation entry = mValueToEnum.get(value);
        if (entry != null) {
            return entry;
        }
        throw new IllegalArgumentException(new StringBuilder("No enum const class ")
                .append(CmsOperation.class.getName()).append("").append(value).toString());
    }
}
