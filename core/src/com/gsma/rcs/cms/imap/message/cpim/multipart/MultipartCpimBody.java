    ...
    protected void parseBody(String body) {
        ...
        if(2 == parts.length ){
            ...
            if(!checkMultipart(getContentType())){
                StringBuilder message = new StringBuilder("This content type is not supported").append(Constants.CRLF).append(body);
            ...
            String multipartContent = parts[1].substring(length, parts[1].lastIndexOf(Constants.BOUDARY_SEP));
