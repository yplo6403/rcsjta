...
public class CmsOperationListenerMock implements CmsOperationListener {
    ...
    private static final Logger sLogger = Logger.getLogger(CmsOperationListenerMock.class
            .getSimpleName());
    ...
    @Override
    public void onCmsOperationExecuted(CmsOperation operation, SyncType syncType, boolean result,
            Object param) {
