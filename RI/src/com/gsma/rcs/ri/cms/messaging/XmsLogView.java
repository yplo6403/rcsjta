 ...
 */
public class XmsLogView extends RcsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xms_log_item);
    ...
    protected void onResume() {
        super.onResume();
        XmsDataObject dao = XmsDataObject.getXms(this, mMessageId);
        if (dao == null) {
    ...
    /**
     * Start activity to view details of XMS message record
     *
     * @param context the context
     * @param messageId the message ID
     */
    public static void startActivity(Context context, String messageId) {
        Intent intent = new Intent(context, XmsLogView.class);
