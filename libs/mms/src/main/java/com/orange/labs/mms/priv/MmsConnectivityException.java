 ...
 */
public class MmsConnectivityException extends MmsException {
     ...
     */
    public MmsConnectivityException(String message) {
        super(message);
    }
     ...
     */
    public MmsConnectivityException(String message, Throwable cause) {
        super(message, cause);
    }
}
