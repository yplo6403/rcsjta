...
public class MmsConfig {
    ...
    private static final String DEFAULT_USER_AGENT = "Android-Mms/2.0"; //TODO changer le user agent pour que ça passe partout
    ...
    public static void init(Context context) {
        if (LOCAL_LOGV) {
            Log.v(Constants.TAG, "MmsConfig.init()");
        }
    ...
    public static int getMaxMessageSize() {
        if (LOCAL_LOGV) {
            Log.v(Constants.TAG, "MmsConfig.getMaxMessageSize(): " + mMaxMessageSize);
        }
    ...
    private static void loadMmsSettings(Context context) {
        ...
        try {
            ...
            while (true) {
                ...
                if (DEBUG) {
                    Log.v(Constants.TAG, "tag: " + tag + " value: " + value + " - " +
                            text);
                }
            ...
            Log.e(Constants.TAG, "loadMmsSettings caught ", e);
