...
public class NotificationTransaction extends Transaction implements Runnable {
    ...
    public NotificationTransaction(
        ...
        try {
            ...
            try {
                group = com.klinker.android.send_message.Transaction.mSettings.getGroup();
            } catch (Exception e) {
            ...
            if (retrieveConfData != null) {
                ...
                if ((pdu == null) || (pdu.getMessageType() != MESSAGE_TYPE_RETRIEVE_CONF)) {
                    ...
                    Uri uri = p.persist(pdu, Inbox.CONTENT_URI, true,
                            com.klinker.android.send_message.Transaction.mSettings.getGroup(), null);
                    ...
                    // Modified by Orange
                    com.klinker.android.send_message.Transaction.notifyXmsEvent(mContext, uri,
                            com.klinker.android.send_message.Transaction.XmsEvent.MMS_RECEIVED);
                }
            }
