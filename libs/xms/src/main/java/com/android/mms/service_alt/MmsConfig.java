...
public class MmsConfig {
    ...
    // if true, show the cell broadcast (amber alert) in the SMS mSettings. Some carriers
    ...
    public MmsConfig(Context context, int subId) {
        ...
        // Load User-Agent and UA profile URL mSettings
        ...
        Log.v(TAG, "MmsConfig: all mSettings -- " + mKeyValues);
    }
