...
/**
 * Container of transaction mSettings. Instances of this class are contained
 * within Transaction instances to allow overriding of the default APN
 * mSettings or of the MMS Client.
 */
public class TransactionSettings {
    ...
    /**
     * Constructor that uses the default mSettings of the MMS Client.
     *
