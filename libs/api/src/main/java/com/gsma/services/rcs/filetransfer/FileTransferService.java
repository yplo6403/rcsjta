...
public final class FileTransferService extends RcsService {
    ...
    /**
     * Returns true if it is possible to download a file transfer (synchronized from CMS) specified
     * by the transferId parameter, else returns false. Downloading a file is only applicable for
     * secondary devices.
     *
     * @param transferId the file transfer ID
     * @return boolean
     ...
     * @throws RcsGenericException
     */
    public boolean isAllowedToDownloadFile(String transferId) throws RcsPersistentStorageException,
            RcsServiceNotAvailableException, RcsGenericException {
        if (mApi == null) {
            throw new RcsServiceNotAvailableException();
        }
