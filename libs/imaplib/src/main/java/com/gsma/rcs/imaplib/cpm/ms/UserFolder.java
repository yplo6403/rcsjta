 ...
 * Description [OMA-CPM-SD]. A user may only create their folders under manage their stored
 * information. A user defined folder is similar to a folder created for a file management system
 * and the user can manipulate the contents in it freely; such as: - store a standalone media object
 * in it - copy any objects from other folders into it - remove any objects in it and move any
 * objects in it to other user defined folders
 */
