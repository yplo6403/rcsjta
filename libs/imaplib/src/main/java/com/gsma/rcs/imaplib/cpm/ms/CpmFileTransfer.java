 ...
 * 01234567-89ab-cdef-0123-456789abcdef Content-type: multipart/related;boundary=cpm; Content-Type:
 * Application/X-CPM-File-Transfer <file-object> <cid>cid:<1234@example.com></cid> <sdp> i=This is
 * my latest picture a=sendonly a=file-selector:name:"My picture.jpg" type:image/jpeg size:4092
 * a=file-disposition:render a=file-date:creation:"Mon, 15 May 2006 15:01:31 +0300" </sdp>
 * </file-object> --cpm Content-Type: image/jpeg Content-Transfer-Encoding: binary Content-ID:
 * <1234@example.com> ... My picture.jpg...
 */
