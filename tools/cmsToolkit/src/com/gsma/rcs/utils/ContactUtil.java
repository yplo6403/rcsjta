...
import com.orangelabs.rcs.cms.toolkit.Toolkit;
    ...
    public static PhoneNumber getValidPhoneNumberFromAndroid(String contact) {
        synchronized (ContactUtil.class) {
            if (mContactUtil == null) {
                mContactUtil = com.gsma.services.rcs.contact.ContactUtil.getInstance(Toolkit
                        .getAppContext());
            }
        }
        try {
            ...
            sLogger.severe(new StringBuilder("Failed to validate phone number from Android '")
